...
class Calendar(ttk.Frame):
    ...
    def __init__(self, master=None, **kw):
        ...
        if locale is None:
            locale = 'en'
        self._day_names = ["Lun", "Mar", "Mie", "Jue", "Vie", "Sab", "Dom"]
        #get_day_names('abbreviated', locale=locale) borre esto en donde puse la lista de dias para que este en español - PedroxionX
        self._month_names = get_month_names('wide', locale="es_ES")
        #["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"]
        #get_month_names('wide', locale=locale) borre esto en donde puse la lista de dias para que este en español - PedroxionX
        # Actualizacion, en lugar de borrarlo busque los locale y tiene una opcion con los nombres en español
